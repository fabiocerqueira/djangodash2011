...
DATABASES = {
    'default': {
        ...
        'NAME': 'pylestras.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '_w^u#rdjpmyputj0ht!6z*$3!za0wzupa@yrsfb=98j4dp1-ig'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    # Site
    'context_processors.site_context_processors',
)
